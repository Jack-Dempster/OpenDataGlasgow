var map = L.map(document.getElementById("map")).setView([55.857925, -4.251879], 14);

var streets = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}',
    {
        attribution: 'Tiles by <a href="http://mapc.org">MAPC</a>, Data by <a href="https://data.glasgow.gov.uk">MassGIS</a>',
        maxZoom: 17,
        minZoom: 8,
        id: 'mapbox.streets',
